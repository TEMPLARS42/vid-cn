    ...
    useEffect(() => {
        ...
        if (!playerRef.current) {
            ...
            playerRef.current = videojs(videoElement, {
                ...
                sources: [{
                    src: "https://vid-cn.s3.ap-south-1.amazonaws.com/uploads/kdkd2389/master.m3u8", // HLS master playlist with multiple quality levels
            ...
            console.log(playerRef.current.qualityLevels())

            // Load the initial source
            playerRef.current.hlsQualitySelector({
                displayCurrentQuality: true, // This will display the current quality in the selector
            });
            playerRef.current.src([{ src: `${qualitySources["360p"]}`, type: "application/x-mpegURL" }]);
        }
        else {
            const player = playerRef.current;
            player.src([{ src: "https://vid-cn.s3.ap-south-1.amazonaws.com/uploads/kdkd2389/master.m3u8", type: "application/x-mpegURL" }]);
            player.load();
        }
    }, [videoInfo]);
